...
current_version=$(cat wordpress-plugin-boilerplate.php | grep -o -P 'Version: ^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$')

# Replace the version in the plugin file
sed -i "s/Version: $current_version.*/Version: $new_version/g" wordpress-plugin-boilerplate.php
